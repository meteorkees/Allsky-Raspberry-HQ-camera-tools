...
observer_location.lon='0.0000' #longtitide in decimal degrees. East = +
# %% these parameters are for super-precise estimates, not necessary.
observer_location.elevation = 6 # meters above mean sealevel (assuming the IERS 1989 ellipsoid (flattening =1/298.257))
